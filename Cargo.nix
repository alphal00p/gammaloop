    ...
    crates = {
      ...
      "linnet" = rec {
        ...
        features = {
          ...
          "symbolica" = [ "dep:symbolica" "dep:symbolica-utils" ];
        };
      ...
      "symbolica-utils" = rec {
        crateName = "symbolica-utils";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/symbolica-utils; };
        libName = "symbolica_utils";
        dependencies = [
          {
            name = "bincode";
            packageId = "bincode 2.0.1";
