...
pub struct Validate {
    ...
    /// Write the validation result as JSON instead of printing it.
...
pub struct Build {
    ...
    /// Skip saving the oriented expression and workspace pointer.
    ...
    /// Show detailed terms for the selected orientation.
    #[arg(long)]
    pub show_details_for_orientation: Option<String>,

    /// Directory for generated expression artifacts and the latest-expression pointer.
    #[arg(long, value_hint = clap::ValueHint::DirPath)]
    pub workspace_path: Option<PathBuf>,

    /// Override the output JSON path for the oriented expression.
    #[arg(long, value_hint = clap::ValueHint::FilePath)]
    pub json_out: Option<PathBuf>,
}
