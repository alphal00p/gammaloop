...
fn parse_val() {
    ...
    digraph {
      ...
      7	 [label = "T:g(cof(3,hedge_2),dind(cof(3,hedge_1)))"];
      8	 [label = "T:g(cof(3,hedge_1),dind(cof(3,hedge_2)))"];
      ...
      8:40:s	-> 0:8:s	 [id=8  color="red:blue;0.5"];
      7:37:s	-> 0:9:s	 [id=9  color="red:blue;0.5"];
      6:33:s	-> 0:10:s	 [id=10  color="red:blue;0.5"];
      5:29:s	-> 0:11:s	 [id=11  color="red:blue;0.5"];
      4:25:s	-> 0:12:s	 [id=12  color="red:blue;0.5"];
      3:21:s	-> 0:13:s	 [id=13  color="red:blue;0.5"];
      2:17:s	-> 0:14:s	 [id=14  color="red:blue;0.5"];
      1:16:s	-> 0:15:s	 [id=15  color="red:blue;0.5"];
      2:20:s	-> 13:52:s	 [id=16 dir=none  color="red:blue;0.5" label="mink4|hedge_0"];
      2:18:s	-> 12:50:s	 [id=17 dir=none  color="red:blue;0.5" label="bis4|hedge_2"];
      2:19:s	-> 6:35:s	 [id=18 dir=none  color="red:blue;0.5" label="bis4|hedge_8"];
      3:24:s	-> 14:54:s	 [id=19 dir=none  color="red:blue;0.5" label="mink4|hedge_3"];
      3:22:s	-> 11:48:s	 [id=20 dir=none  color="red:blue;0.5" label="bis4|hedge_1"];
      3:23:s	-> 4:26:s	 [id=21 dir=none  color="red:blue;0.5" label="bis4|hedge_5"];
      4:27:s	-> 5:30:s	 [id=22 dir=none  color="red:blue;0.5" label="bis4|hedge_6"];
      4:28:s	-> 9:44:s	 [id=23 dir=none  color="red:blue;0.5" label="mink4|edge_5_1"];
      5:31:s	-> 6:34:s	 [id=24 dir=none  color="red:blue;0.5" label="bis4|hedge_7"];
      5:32:s	-> 15:56:s	 [id=25 dir=none  color="red:blue;0.5" label="mink4|hedge_4"];
      6:36:s	-> 10:46:s	 [id=26 dir=none  color="red:blue;0.5" label="mink4|edge_6_1"];
      7:39:s	-> 8:41:s	 [id=27 dir=back  color="red:blue;0.5" label="cof🠓3|_hedge_1"];
      7:38:s	-> 8:42:s	 [id=28  color="red:blue;0.5" label="cof🠑3|^hedge_2"];
    }
    "#);
    assert_eq!(net.simple_execute::<()>(), expr);
