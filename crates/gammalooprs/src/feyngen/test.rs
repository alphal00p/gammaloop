...
fn gl_11_vs_gl_12() {
    ...
    let gl_12:Graph = dot!(
        ...
        projector = "ϵ(0,spenso::mink(4,hedge(1)))*ϵ(0,spenso::mink(4,hedge(0)))";
        // projector = "spenso::g(spenso::mink(4,hedge(1)),spenso::mink(4,hedge(0)))";
        0[dod=0 int_id=V_79 num_old="(UFO::GC_58*(-2*spenso::gamma(spenso::mink(4,hedge(4)),spenso::bis(4,hedge(6)),spenso::bis(4,vertex(0,1)))*spenso::projp(spenso::bis(4,vertex(0,1)),spenso::bis(4,hedge(2)))+spenso::gamma(spenso::mink(4,hedge(4)),spenso::bis(4,hedge(6)),spenso::bis(4,vertex(0,1)))*spenso::projm(spenso::bis(4,vertex(0,1)),spenso::bis(4,hedge(2))))+UFO::GC_50*spenso::gamma(spenso::mink(4,hedge(4)),spenso::bis(4,hedge(6)),spenso::bis(4,vertex(0,1)))*spenso::projm(spenso::bis(4,vertex(0,1)),spenso::bis(4,hedge(2))))*spenso::g(spenso::dind(spenso::cof(3,hedge(6))),spenso::cof(3,hedge(2)))"];
        1[dod=0 int_id=V_79 num_old="(UFO::GC_58*(-2*spenso::gamma(spenso::mink(4,hedge(5)),spenso::bis(4,hedge(3)),spenso::bis(4,vertex(1,1)))*spenso::projp(spenso::bis(4,vertex(1,1)),spenso::bis(4,hedge(8)))+spenso::gamma(spenso::mink(4,hedge(5)),spenso::bis(4,hedge(3)),spenso::bis(4,vertex(1,1)))*spenso::projm(spenso::bis(4,vertex(1,1)),spenso::bis(4,hedge(8))))+UFO::GC_50*spenso::gamma(spenso::mink(4,hedge(5)),spenso::bis(4,hedge(3)),spenso::bis(4,vertex(1,1)))*spenso::projm(spenso::bis(4,vertex(1,1)),spenso::bis(4,hedge(8))))*spenso::g(spenso::dind(spenso::cof(3,hedge(3))),spenso::cof(3,hedge(8)))"];
        2[dod=0 int_id=V_71 num_old="UFO::GC_1*spenso::g(spenso::dind(spenso::cof(3,hedge(9))),spenso::cof(3,hedge(10)))*spenso::gamma(spenso::mink(4,hedge(0)),spenso::bis(4,hedge(9)),spenso::bis(4,hedge(10)))"];
        3[dod=0 int_id=V_71 num_old="UFO::GC_1*spenso::g(spenso::dind(spenso::cof(3,hedge(11))),spenso::cof(3,hedge(7)))*spenso::gamma(spenso::mink(4,hedge(1)),spenso::bis(4,hedge(11)),spenso::bis(4,hedge(7)))"];
        2:1-> 3:0 [id=0 dir=none source="{ufo_order:2}" sink="{ufo_order:2}"  dod=-2 is_cut=0  lmb_rep="P(0,a___)" name=e0 num_old="1" particle="a"];
        1:8-> 2:9 [id=1 dir=back source="{ufo_order:1}" sink="{ufo_order:0}"  dod=-1  lmb_rep="K(0,a___)+K(1,a___)" name=e1 num_old="Q(1,spenso::mink(4,edge(1,1)))*spenso::g(spenso::dind(spenso::cof(3,hedge(8))),spenso::cof(3,hedge(9)))*spenso::gamma(spenso::mink(4,edge(1,1)),spenso::bis(4,hedge(8)),spenso::bis(4,hedge(9)))" particle="d~"];
        0:2-> 1:3 [id=2 dir=back source="{ufo_order:1}" sink="{ufo_order:0}"  dod=-1  lmb_id=0 lmb_rep="K(0,a___)" name=e2 num_old="Q(2,spenso::mink(4,edge(2,1)))*spenso::g(spenso::dind(spenso::cof(3,hedge(2))),spenso::cof(3,hedge(3)))*spenso::gamma(spenso::mink(4,edge(2,1)),spenso::bis(4,hedge(2)),spenso::bis(4,hedge(3)))" particle="d~"];
        0:4-> 1:5 [id=3 dir=none source="{ufo_order:2}" sink="{ufo_order:2}"  dod=0   lmb_rep="K(1,a___)" name=e3 num_old="-spenso::g(spenso::mink(4,hedge(4)),spenso::mink(4,hedge(5)))+UFO::MZ^-2*Q(3,spenso::mink(4,hedge(4)))*Q(3,spenso::mink(4,hedge(5)))" particle="Z"];
        0:6-> 3:7 [id=4 source="{ufo_order:0}" sink="{ufo_order:1}"  dod=-1  lmb_id=1 lmb_rep="-K(0,a___)-K(1,a___)" name=e4 num_old="Q(4,spenso::mink(4,edge(4,1)))*spenso::g(spenso::dind(spenso::cof(3,hedge(7))),spenso::cof(3,hedge(6)))*spenso::gamma(spenso::mink(4,edge(4,1)),spenso::bis(4,hedge(7)),spenso::bis(4,hedge(6)))" particle="d"];
        2:10-> 3:11 [id=5 dir=back source="{ufo_order:1}" sink="{ufo_order:0}"  dod=-1  lmb_rep="-P(0,a___)+K(0,a___)+K(1,a___)" name=e5 num_old="Q(5,spenso::mink(4,edge(5,1)))*spenso::g(spenso::dind(spenso::cof(3,hedge(10))),spenso::cof(3,hedge(11)))*spenso::gamma(spenso::mink(4,edge(5,1)),spenso::bis(4,hedge(10)),spenso::bis(4,hedge(11)))" particle="d~"];
        }
    ).unwrap();
    ...
    let gl_11:Graph = dot!(
        digraph GL11{
            ...
            projector = "ϵ(0,spenso::mink(4,hedge(1)))*ϵ(0,spenso::mink(4,hedge(0)))";
            // projector = "spenso::g(spenso::mink(4,hedge(1)),spenso::mink(4,hedge(0)))";
            0[dod=0 int_id=V_79 num_old="(UFO::GC_58*(-2*spenso::gamma(spenso::mink(4,hedge(4)),spenso::bis(4,hedge(2)),spenso::bis(4,vertex(0,1)))*spenso::projp(spenso::bis(4,vertex(0,1)),spenso::bis(4,hedge(6)))+spenso::gamma(spenso::mink(4,hedge(4)),spenso::bis(4,hedge(2)),spenso::bis(4,vertex(0,1)))*spenso::projm(spenso::bis(4,vertex(0,1)),spenso::bis(4,hedge(6))))+UFO::GC_50*spenso::gamma(spenso::mink(4,hedge(4)),spenso::bis(4,hedge(2)),spenso::bis(4,vertex(0,1)))*spenso::projm(spenso::bis(4,vertex(0,1)),spenso::bis(4,hedge(6))))*spenso::g(spenso::dind(spenso::cof(3,hedge(2))),spenso::cof(3,hedge(6)))"];
            1[dod=0 int_id=V_79 num_old="(UFO::GC_58*(-2*spenso::gamma(spenso::mink(4,hedge(5)),spenso::bis(4,hedge(8)),spenso::bis(4,vertex(1,1)))*spenso::projp(spenso::bis(4,vertex(1,1)),spenso::bis(4,hedge(3)))+spenso::gamma(spenso::mink(4,hedge(5)),spenso::bis(4,hedge(8)),spenso::bis(4,vertex(1,1)))*spenso::projm(spenso::bis(4,vertex(1,1)),spenso::bis(4,hedge(3))))+UFO::GC_50*spenso::gamma(spenso::mink(4,hedge(5)),spenso::bis(4,hedge(8)),spenso::bis(4,vertex(1,1)))*spenso::projm(spenso::bis(4,vertex(1,1)),spenso::bis(4,hedge(3))))*spenso::g(spenso::dind(spenso::cof(3,hedge(8))),spenso::cof(3,hedge(3)))"];
            2[dod=0 int_id=V_71 num_old="UFO::GC_1*spenso::g(spenso::dind(spenso::cof(3,hedge(10))),spenso::cof(3,hedge(9)))*spenso::gamma(spenso::mink(4,hedge(0)),spenso::bis(4,hedge(10)),spenso::bis(4,hedge(9)))"];
            3[dod=0 int_id=V_71 num_old="UFO::GC_1*spenso::g(spenso::dind(spenso::cof(3,hedge(7))),spenso::cof(3,hedge(11)))*spenso::gamma(spenso::mink(4,hedge(1)),spenso::bis(4,hedge(7)),spenso::bis(4,hedge(11)))"];
            2:1-> 3:0 [id=0 dir=none source="{ufo_order:2}" sink="{ufo_order:2}"  dod=-2 is_cut=0  lmb_rep="P(0,a___)" name=e0 num_old="1" particle="a"];
            1:8-> 2:9 [id=1 source="{ufo_order:0}" sink="{ufo_order:1}"  dod=-1  lmb_rep="K(0,a___)+K(1,a___)" name=e1 num_old="Q(1,spenso::mink(4,edge(1,1)))*spenso::g(spenso::dind(spenso::cof(3,hedge(9))),spenso::cof(3,hedge(8)))*spenso::gamma(spenso::mink(4,edge(1,1)),spenso::bis(4,hedge(9)),spenso::bis(4,hedge(8)))" particle="d"];
            0:2-> 1:3 [id=2 source="{ufo_order:0}" sink="{ufo_order:1}"  dod=-1  lmb_id=0 lmb_rep="K(0,a___)" name=e2 num_old="Q(2,spenso::mink(4,edge(2,1)))*spenso::g(spenso::dind(spenso::cof(3,hedge(3))),spenso::cof(3,hedge(2)))*spenso::gamma(spenso::mink(4,edge(2,1)),spenso::bis(4,hedge(3)),spenso::bis(4,hedge(2)))" particle="d"];
            0:4-> 1:5 [id=3 dir=none source="{ufo_order:2}" sink="{ufo_order:2}"  dod=0   lmb_rep="K(1,a___)" name=e3 num_old="-spenso::g(spenso::mink(4,hedge(4)),spenso::mink(4,hedge(5)))+UFO::MZ^-2*Q(3,spenso::mink(4,hedge(4)))*Q(3,spenso::mink(4,hedge(5)))" particle="Z"];
            0:6-> 3:7 [id=4 dir=back source="{ufo_order:1}" sink="{ufo_order:0}"  dod=-1  lmb_id=1 lmb_rep="-K(0,a___)-K(1,a___)" name=e4 num_old="Q(4,spenso::mink(4,edge(4,1)))*spenso::g(spenso::dind(spenso::cof(3,hedge(6))),spenso::cof(3,hedge(7)))*spenso::gamma(spenso::mink(4,edge(4,1)),spenso::bis(4,hedge(6)),spenso::bis(4,hedge(7)))" particle="d~"];
            2:10-> 3:11 [id=5 source="{ufo_order:0}" sink="{ufo_order:1}"  dod=-1  lmb_rep="-P(0,a___)+K(0,a___)+K(1,a___)" name=e5 num_old="Q(5,spenso::mink(4,edge(5,1)))*spenso::g(spenso::dind(spenso::cof(3,hedge(11))),spenso::cof(3,hedge(10)))*spenso::gamma(spenso::mink(4,edge(5,1)),spenso::bis(4,hedge(11)),spenso::bis(4,hedge(10)))" particle="d"];
        }
        ).unwrap();
