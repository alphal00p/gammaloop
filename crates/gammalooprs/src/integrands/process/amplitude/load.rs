...
//! symbolica = { git = "https://github.com/symbolica-dev/symbolica", rev = "d6bb961d22c026c4866b2e698f56fbb964c4ee0e", default-features = false, features = ["bincode", "float-mpfr", "integer-gmp", "native_code_generation", "serde"] }
//! [patch.crates-io]
//! numerica = { git = "https://github.com/symbolica-dev/symbolica", rev = "d6bb961d22c026c4866b2e698f56fbb964c4ee0e" }
//! graphica = { git = "https://github.com/symbolica-dev/symbolica", rev = "d6bb961d22c026c4866b2e698f56fbb964c4ee0e" }
//! ```
