...
impl From<&Vertex> for DotVertexData {
    fn from(value: &Vertex) -> Self {
        ...
        if !value.name.autogenerated {
            v.name = Some(value.name.value.clone());
        }
        if let Some(vertex_rule) = &value.vertex_rule {
            v.add_statement("int_id", vertex_rule.name.as_str());
        }
        if !value.dod.autogenerated {
            v.add_statement("dod", value.dod.value);
        }
        if !value.num.autogenerated {
            v.add_statement("num", value.num.value.to_quoted());
        }
        v
    }
}
