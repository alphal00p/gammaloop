...
| Actual maximum | Physical cut1 R [GeV] | Main measured CT configuration | Star R [GeV] | Star gluon13/14 energies [GeV] |
|---|---:|---|---:|---:|
| Shared b/c Re, seed40009 |125.907|Cut3 right[5,10], parent[4,5,7,12], active[5]|51.1309|89.217/349.104|
| b Im, seed40009/lu_cut_5 |29.0311|Cut1 native2l A=[7,8], parent[3,6,7,10], active[3,7]|1.57488|185.803/478.966|
| c absolute-Im, seed20011/lu_cut_0 |23.9737|Cut1 native2l U=[8,12,14], same native parent/active slots|12.1308|187.177/271.100|
...
The artifact extension is [maximum_extension_build7](gl638_hosted_joint_gate/mc_confirmation/maximum_extension_build7/provenance.json), with exact source/hash index, top4 replays, immutable JSONL traces, native analyses and the same-point factor audit. The original [confirmation result](GL638_MC_CONFIRMATION.md) and [screen maximum study](GL638_MAXIMUM_PHYSICS_ATTRIBUTION.md) remain separate. Component norm ratios are not signed rate fractions. Finite maxima and two regular H/Z approaches cannot establish global boundedness, soft integrability or finite variance; those require the separately scoped soft/replacement study.
