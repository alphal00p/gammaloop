...
Reproducible records: #link("gl638_hosted_joint_gate/mc_maximum_replay/traces/analysis/analysis.json.gz")[analysis];, #link("gl638_hosted_joint_gate/mc_maximum_replay/traces/analysis/analyze_max_native_trace.py.gz")[native trace postprocessor];, and #link("gl638_hosted_joint_gate/mc_maximum_replay/traces/analysis/ATTRIBUTION.typ")[detailed scope];. The same existing maximum replayer is reserved for the final complete confirmation, after its statistics and program provenance pass their existing gates.
