...
Same frozen X1 source `3f9b1a28473f313d6242a556ada2e8dbcd6f6477` and binary SHA256 `f700ee575153067ccc77894ea776a96f139105812a15014d094dd67ba7db6d61` as the #link("AMPLITUDE_X1_KITE_MATRIX.typ")[kite pilot];. All 98 double-box orientations are summed, threshold CTs are enabled, power 2, exact map-density partition, real training. Seeds 101/202/303 each have 10,000 draws in five batches on one core. All 12 integrations completed with no reported NaN/unstable points.

#figure(
  align(center)[#table(
    columns: 5,
    align: (auto,right,right,right,right,),
    table.header([Channels], [Mean Re / Im], [RMS error Re / Im], [Max absolute weight Re / Im], [Evaluation µs],),
    table.hline(),
    [optimized\_lmb], [-1.8515e-08 / -2.7573e-07], [1.152e-08 / 1.746e-08], [1.037e-04 / 1.137e-04], [90.87],
    [all\_lmb], [-1.8515e-08 / -2.7573e-07], [1.152e-08 / 1.746e-08], [1.037e-04 / 1.137e-04], [91.23],
...
#figure(
  align(center)[#table(
    ...
    table.header([Reference channels], [Normalization], [Raw second moment],),
    table.hline(),
    [optimized\_lmb], [0.98936452], [8.93863347],
    [all\_lmb], [0.98936452], [8.93863347],
...
#figure(
  align(center)[#table(
    columns: 5,
    align: (auto,right,right,right,right,),
    table.header([Boosted-kite channels], [Mean Re / Im], [RMS error Re / Im], [Max absolute weight Re / Im], [Evaluation µs],),
    table.hline(),
    [optimized\_lmb], [-1.3698e-05 / 6.7005e-06], [3.517e-07 / 1.062e-06], [1.701e-03 / 1.158e-03], [81.30],
    [all\_lmb], [-1.3698e-05 / 6.7005e-06], [3.517e-07 / 1.062e-06], [1.701e-03 / 1.158e-03], [80.84],
...
#figure(
  align(center)[#table(
    columns: 3,
    align: (auto,right,right,),
    table.header([Boosted-kite reference channels], [Normalization], [Raw second moment],),
    table.hline(),
    [optimized\_lmb], [0.98292699], [8.95521153],
    [all\_lmb], [0.98292699], [8.95521153],
