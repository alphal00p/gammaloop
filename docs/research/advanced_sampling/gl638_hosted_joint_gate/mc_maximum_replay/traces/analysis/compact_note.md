...
Reproducible records: [analysis](gl638_hosted_joint_gate/mc_maximum_replay/traces/analysis/analysis.json), [native trace postprocessor](gl638_hosted_joint_gate/mc_maximum_replay/traces/analysis/analyze_max_native_trace.py), and [detailed scope](gl638_hosted_joint_gate/mc_maximum_replay/traces/analysis/ATTRIBUTION.md). The same existing maximum replayer is reserved for the final complete confirmation, after its statistics and program provenance pass their existing gates.
