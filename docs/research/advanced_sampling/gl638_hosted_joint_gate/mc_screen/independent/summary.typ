...
Selected a = optimized\_lmb, b = cuts, c = cuts\_combined\_joint. The composed score is only 0.03947% below direct joint; this screen does not establish superiority between them.
