...
#figure(
  align(center)[#table(
    ...
    table.header([Selection], [Status], [Selected / passed], [Excluded], [Receipt],),
    table.hline(),
...
#figure(
  align(center)[#table(
    columns: (20%, 20%, 20%, 20%, 20%),
    align: (auto,auto,auto,auto,auto,),
    table.header([Boundary / stage], [Status], [Executed revision / final document target], [Seconds], [Receipt],),
    table.hline(),
...
#figure(
  align(center)[#table(
    columns: (20%, 20%, 20%, 20%, 20%),
    align: (auto,auto,auto,auto,auto,),
    table.header([Attempt], [Revision], [Exit / status], [Seconds], [Scope or disposition],),
    table.hline(),
    ...
    [c7/mre-abstract-control], [`a3af927afc63`], [0 / PASS], [0.501], [Standalone MRE build/control evidence; excluded from workspace totals, see raised-energy-cff-mre-validation.typ],
    [c7/mre-build], [`a3af927afc63`], [0 / PASS], [315.154], [Standalone MRE build/control evidence; excluded from workspace totals, see raised-energy-cff-mre-validation.typ],
    [c7/mre-check], [`a3af927afc63`], [0 / PASS], [42.099], [Standalone MRE build/control evidence; excluded from workspace totals, see raised-energy-cff-mre-validation.typ],
    [c7/mre-clippy], [`a3af927afc63`], [0 / PASS], [0.978], [Standalone MRE build/control evidence; excluded from workspace totals, see raised-energy-cff-mre-validation.typ],
    [c7/mre-control], [`a3af927afc63`], [0 / PASS], [0.498], [Standalone MRE build/control evidence; excluded from workspace totals, see raised-energy-cff-mre-validation.typ],
    [c7/mre-fmt-current], [`bbb8ff1db499`], [0 / PASS], [0.479], [Standalone MRE build/control evidence; excluded from workspace totals, see raised-energy-cff-mre-validation.typ],
    [c7/mre-import-read], [`a3af927afc63`], [101 / FAIL], [0.493], [Standalone import diagnostic; expected assertion exit 101, separately source-scoped in raised-energy-cff-mre-validation.typ],
    [c7/mre-import-write], [`a3af927afc63`], [0 / PASS], [0.495], [Standalone MRE build/control evidence; excluded from workspace totals, see raised-energy-cff-mre-validation.typ],
...
New receipts record complete pinned tracked-file Git blobs, symlink target bytes and executable modes in tracked\_before/after, plus HEAD and the Spenso source fingerprint. Earlier receipts without those fields check only HEAD and crates/spenso/src/network/mod.rs; they retain that narrower scope. The report does not upgrade old guards or claim to inspect untracked files. Selected binary hashes are separate evidence.
...
<c1spenso-no-default-tests-list>
...
<c2three-dimensional-reps-all-check>
...
<c2three-dimensional-reps-all-tests>
...
<c2three-dimensional-reps-all-tests-list>
...
<c2three-dimensional-reps-no-default-check>
...
<c2three-dimensional-reps-no-default-tests>
...
<c2three-dimensional-reps-no-default-tests-list>
...
<c7physical-local-uv-routes-list>
...
<c7physical-local-uv-routes-v2-list>
...
<c7uv-performance-outward-v2-list>
...
<c8physical-local-uv-routes-list>
...
<c8spenso-no-default-tests-list>
...
<c8three-dimensional-reps-all-check>
...
<c8three-dimensional-reps-all-tests>
...
<c8three-dimensional-reps-all-tests-list>
...
<c8three-dimensional-reps-default-check>
...
<c8three-dimensional-reps-default-tests>
...
<c8three-dimensional-reps-default-tests-list>
...
<c8three-dimensional-reps-no-default-check>
...
<c8three-dimensional-reps-no-default-tests>
...
<c8three-dimensional-reps-no-default-tests-list>
