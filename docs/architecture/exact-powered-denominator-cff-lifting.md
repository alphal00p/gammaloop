...
invariants; source-pinned measurements and remaining limitations, including the
GL262 evaluator-construction panic, are recorded in
...
on the reconstructed stack. GL262 retains the source-pinned limitation described
in the [performance report](local-4d-uv-performance.md); fresh outcomes belong to
the [stack validation receipt](raised-energy-cff-stack-review-validation.md).
