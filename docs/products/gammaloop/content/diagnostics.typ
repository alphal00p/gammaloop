...
#callout("Before you start", [
  *Prerequisites:* a built GammaLoop CLI and a state or run card that reaches the behavior you
  ...
  for #link("reference/cli/settings/cli/global/#setting-cli-global-display-directive-6a4c9a96965b6130")[persistence and state controls].
])
...
- #link("reference/cli/settings/cli/global/#setting-cli-global-display-directive-6a4c9a96965b6130")[`display_directive = "info"`]
- #link("reference/cli/settings/cli/global/#setting-cli-global-logfile-directive-e534bdfa5512b136")[`logfile_directive = "off"`]
