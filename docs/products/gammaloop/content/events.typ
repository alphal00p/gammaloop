...
`use_arb_prec=true` forces arbitrary-precision (Arb) internal evaluation, using the configured
Arb stability level when available and a default Arb level otherwise.
