...
NixCI. See [CONTRIBUTING.md](../CONTRIBUTING.md#nixci-cache) for credentials,
...
reason to invalidate it. See the [cache-reuse audit](architecture/nix-crane-cache-reuse.md)
...
and [candidate](https://nix-ci.com/gh:alphal00p:gammaloop/codex%2Fci-lazy-check-runners/dd6ba768692302ca4855727110c4d8422b0979f9).

| Warm NixCI measurement | Before | After |
|---|---:|---:|
...
| Controlled local runtime comparison | Before / Cargo | After / Nix |
|---|---:|---:|
...
[final warm data][warm-data], [local artifact and coverage results][local-data],
[cold commands and results][cold-data], and [experiment history][history]. This
...
[warm-data]: https://github.com/alphal00p/gammaloop/blob/0cc8cd2bb42a2e5d1bebe468df347d1d5420d897/docs/ci-final-warm-comparison.json
[local-data]: https://github.com/alphal00p/gammaloop/blob/0cc8cd2bb42a2e5d1bebe468df347d1d5420d897/docs/ci-artifact-preparation-results.json
[cold-data]: https://github.com/alphal00p/gammaloop/blob/0cc8cd2bb42a2e5d1bebe468df347d1d5420d897/docs/ci-cold-cargo-comparison.json
[history]: https://github.com/alphal00p/gammaloop/tree/0cc8cd2bb42a2e5d1bebe468df347d1d5420d897/docs
