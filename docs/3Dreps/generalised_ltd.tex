...
residue orientation in the surface map.  The remaining representation bridges
are global convention factors: the LTD LU loop-measure parity
...
exponent used for expanded-four-dimensional UV counterterms.  Neither depends
on a graph label or on a fitted sign from tests.
