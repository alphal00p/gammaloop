...
parser.add_argument(
    "--gammaloop_state", "-s", type=str, help="Path to the GammaLoop state directory. Default=%(default)s", default="./states/qqx_aaa_euclidean"
)
parser.add_argument("--graph_names", "-g", type=str, nargs="*", default=None, help="Graph names to consider. Default=all")

parser.add_argument(
    "--gammaloop_executable",
    "-e",
    type=str,
    help="Path to the GammaLoop executable. Default=%(default)s",
    default="../../../../target/dev-optim/gammaloop",
)
