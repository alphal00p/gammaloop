...
class TestProcessGeneration:
    ...
    def test_slow_vaccuum_amplitude_generation(self):
        ...
        tests: list[tuple[str, int, str | None]] = [
            ...
            ('{} > {} | g ghg t u d QED==0 [{5}] -a -num_grouping only_detect_zeroes --max_n_bridges 0 --number_of_factorized_loop_subtopologies 1', snapshot(2560), snapshot("-46399/2688")),
            ('{} > {} | g ghg t u d QED==0 [{5}] -a -num_grouping group_identical_graphs_up_to_scalar_rescaling --max_n_bridges 0 --number_of_factorized_loop_subtopologies 1', snapshot(1438), snapshot("220379/51072")),
        ]
        # autopep8: on
        TestProcessGeneration.run_tests(gloop, tests)
