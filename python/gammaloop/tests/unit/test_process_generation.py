...
class TestProcessGeneration:
    ...
    def test_generate_sm_a_ddx(self):
        ...
        tests: list[tuple[str, int, str | None]] = [
            ...
            ('a > d d~ [{{2}}] --symmetrize_left_right_states --compare_canonized_numerator --number_of_samples_for_numerator_comparisons 0 --no-fully_numerical_substitution_when_comparing_numerators', snapshot(10), snapshot("-27*ee^-2*G^2*Nc*TR+27*ee^-2*G^2*Nc^-1*TR-12")),  # nopep8
            ('a > d d~ [{{2}}] --symmetrize_left_right_states --compare_canonized_numerator --number_of_samples_for_numerator_comparisons 0 --fully_numerical_substitution_when_comparing_numerators', snapshot(10), snapshot("-36*ee^-2*G^2-12")),  # nopep8
            ('a > d d~ [{{2}}] --symmetrize_left_right_states --no-compare_canonized_numerator --number_of_samples_for_numerator_comparisons 3 --fully_numerical_substitution_when_comparing_numerators', snapshot(10), snapshot("-36*ee^-2*G^2-12")),  # nopep8
            ('a > d d~ [{{2}}] --symmetrize_left_right_states --no-compare_canonized_numerator --number_of_samples_for_numerator_comparisons 3 --no-fully_numerical_substitution_when_comparing_numerators', snapshot(10), snapshot("-3*TR*Nc+3*TR*Nc^-1-12")),  # nopep8
    ...
    def test_vaccuum_amplitude_generation(self):
        ...
        tests: list[tuple[str, int, str | None]] = [
            ...
            ('{} > {} | g ghg t u d QED==0 [{3}] -a -num_grouping only_detect_zeroes --max_n_bridges -1 --number_of_factorized_loop_subtopologies -1', snapshot(36), snapshot("-71/48")),
            ('{} > {} | g ghg t u d QED==0 [{3}] -a -num_grouping group_identical_graphs_up_to_scalar_rescaling --max_n_bridges -1 --number_of_factorized_loop_subtopologies -1', snapshot(27), snapshot("-71/48")),
            ('{} > {} | g ghg t u d QED==0 [{4}] -a -num_grouping only_detect_zeroes --max_n_bridges -1 --number_of_factorized_loop_subtopologies -1', snapshot(264), snapshot("-787/120")),
            ('{} > {} | g ghg t u d QED==0 [{4}] -a -num_grouping group_identical_graphs_up_to_scalar_rescaling --max_n_bridges -1 --number_of_factorized_loop_subtopologies -1', snapshot(179), snapshot("-4159/840")),
            ...
            ('{} > {} | g ghg t u d QED==0 [{3}] -a -num_grouping only_detect_zeroes --max_n_bridges 0 --number_of_factorized_loop_subtopologies 1', snapshot(29), snapshot("-19/16")),
            ('{} > {} | g ghg t u d QED==0 [{3}] -a -num_grouping group_identical_graphs_up_to_scalar_rescaling --max_n_bridges 0 --number_of_factorized_loop_subtopologies 1', snapshot(21), snapshot("-19/16")),
            ('{} > {} | g ghg t u d QED==0 [{4}] -a -num_grouping only_detect_zeroes --max_n_bridges 0 --number_of_factorized_loop_subtopologies 1', snapshot(212), snapshot("-811/160")),
            ('{} > {} | g ghg t u d QED==0 [{4}] -a -num_grouping group_identical_graphs_up_to_scalar_rescaling --max_n_bridges 0 --number_of_factorized_loop_subtopologies 1', snapshot(138), snapshot("-3877/1120")),
        ]
        # autopep8: on
        TestProcessGeneration.run_tests(gloop, tests)
    ...
    def test_slow_vaccuum_amplitude_generation(self):
        ...
        tests: list[tuple[str, int, str | None]] = [
            ...
            ('{} > {} | g ghg t u d QED==0 [{5}] -a -num_grouping only_detect_zeroes --max_n_bridges 0 --number_of_factorized_loop_subtopologies 1', snapshot(2560), snapshot("-43879/2688")),
            ('{} > {} | g ghg t u d QED==0 [{5}] -a -num_grouping group_identical_graphs_up_to_scalar_rescaling --max_n_bridges 0 --number_of_factorized_loop_subtopologies 1', snapshot(1438), snapshot("502427/51072")),
        ]
        # autopep8: on
        TestProcessGeneration.run_tests(gloop, tests)
    ...
    def test_vaccuum_amplitude_generation_full_sm(self):
        ...
        tests: list[tuple[str, int, str | None]] = [
            ...
            ('{} > {} [{2}] -a -num_grouping group_identical_graphs_up_to_scalar_rescaling --max_n_bridges -1 --number_of_factorized_loop_subtopologies -1 --compare_canonized_numerator --number_of_samples_for_numerator_comparisons 0 --fully_numerical_substitution_when_comparing_numerators', snapshot(293),
             snapshot('-9/2*ee^-2*G^2+187/24')),
            ...
            ('{} > {} [{2}] -a -num_grouping group_identical_graphs_up_to_scalar_rescaling --max_n_bridges -1 --number_of_factorized_loop_subtopologies -1 --compare_canonized_numerator --number_of_samples_for_numerator_comparisons 0 --no-fully_numerical_substitution_when_comparing_numerators', snapshot(281),
             snapshot('-81/8*ee^-2*G^2*Nc*TR+81/8*ee^-2*G^2*Nc^-1*TR-CKM2x1^-1*CKM2x2*complexconjugate(CKM2x1)^-1*complexconjugate(CKM2x2)-CKM3x1^-1*CKM3x2*complexconjugate(CKM3x1)^-1*complexconjugate(CKM3x2)-I2x12^-1*I2x22*I3x21^-1*I3x22-I2x13^-1*I2x23*I3x31^-1*I3x32-CKM1x1^-1*CKM1x2*complexconjugate(CKM1x1)^-1*complexconjugate(CKM1x2)+319/24')),
            ...
            ('{} > {} [{2}] -a -num_grouping group_identical_graphs_up_to_scalar_rescaling --max_n_bridges -1 --number_of_factorized_loop_subtopologies -1 --no-compare_canonized_numerator --number_of_samples_for_numerator_comparisons 3 --fully_numerical_substitution_when_comparing_numerators', snapshot(243),
             snapshot('-27/2*ee^-2*G^2-CKM2x1^-1*CKM2x2*complexconjugate(CKM2x1)^-1*complexconjugate(CKM2x2)-CKM3x1^-1*CKM3x2*complexconjugate(CKM3x1)^-1*complexconjugate(CKM3x2)-I2x12^-1*I2x22*I3x21^-1*I3x22-I2x13^-1*I2x23*I3x31^-1*I3x32-CKM1x1^-1*CKM1x2*complexconjugate(CKM1x1)^-1*complexconjugate(CKM1x2)+313/24')),
