...
// This stage compares CFF local UV from direct 3D expansions with CFF projected
// after typed 4D-local UV construction. The historical LTD third leg remains
// intact in the deferred proper-LTD test delta.
