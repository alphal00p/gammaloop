...
fn test_dis_isr() -> Result<()> {
    let mut cli = get_test_cli(None, get_tests_workspace_path().join("feyn_gen_generation_test"), Some("feyngen".to_string()),true)?;
    cli.run_command(&format!("import model sm.json"))?;
    // cli.run_command(&format!("set global kv global.n_cores.feyngen=4"))?;

    // 2>N amplitude, no symmetrization
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d > e- d | e- a d g ghg QED==2 [{0}] --numerator-grouping only_detect_zeroes",false)?,@"1 | -1 = -1");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d > e- d | e- a d g ghg QED==2 [{1}] --numerator-grouping only_detect_zeroes",false)?,@"1 | -1 = -1");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d > e- d | e- a d g ghg QED==2 [{2}] --numerator-grouping only_detect_zeroes",true)?,@"13 | -13/2 = -13/2");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d > e- d | e- a d g ghg QED==2 [{3}] --numerator-grouping only_detect_zeroes",false)?,@"241 | -194/3 = -194/3");

    // 2>N amplitude, with symmetrization
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d > e- d | e- a d g ghg QED==2 [{0}] --symmetrize-left-right-states true --symmetric-left-right-polarizations true --numerator-grouping group_identical_graphs_up_to_scalar_rescaling",false)?,@"1 | -1 = -1");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d > e- d | e- a d g ghg QED==2 [{1}] --symmetrize-left-right-states true --symmetric-left-right-polarizations true --numerator-grouping group_identical_graphs_up_to_scalar_rescaling",false)?,@"1 | -1 = -1");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d > e- d | e- a d g ghg QED==2 [{2}] --symmetrize-left-right-states true --symmetric-left-right-polarizations true --numerator-grouping group_identical_graphs_up_to_scalar_rescaling",false)?,@"11 | -17/2 = -17/2");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d > e- d | e- a d g ghg QED==2 [{3}] --symmetrize-left-right-states true --symmetric-left-right-polarizations true --numerator-grouping group_identical_graphs_up_to_scalar_rescaling",false)?,@"191 | -332/3+Group(102,1,1)+Group(103,-2/7,1)+Group(104,1,1)+Group(105,-7/2,1)+Group(162,1,1)+Group(163,7/2,1)+Group(164,1,1)+Group(165,2/7,1)+Group(172,1,1)+Group(173,1,1)+Group(315,1,1)+Group(316,-2/7,1) = -2183/21");

    // 3>N no symmetrization
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d g > e- d | e- a d g ghg QED==2 [{0}] --numerator-grouping only_detect_zeroes",false)?,@"2 | -2 = -2");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d g > e- d | e- a d g ghg QED==2 [{1}] --numerator-grouping only_detect_zeroes",false)?,@"13 | -9 = -9");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d g > e- d | e- a d g ghg QED==2 [{2}] --numerator-grouping only_detect_zeroes",false)?,@"225 | -169/2 = -169/2");

    // 3>N with symmetrization
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d g > e- d | e- a d g ghg QED==2 [{0}] --symmetrize-left-right-states true --symmetric-left-right-polarizations true --numerator-grouping group_identical_graphs_up_to_scalar_rescaling",false)?,@"2 | -2 = -2");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d g > e- d | e- a d g ghg QED==2 [{1}] --symmetrize-left-right-states true --symmetric-left-right-polarizations true --numerator-grouping group_identical_graphs_up_to_scalar_rescaling",false)?,@"11 | -11 = -11");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d g > e- d | e- a d g ghg QED==2 [{2}] --symmetrize-left-right-states true --symmetric-left-right-polarizations true --numerator-grouping group_identical_graphs_up_to_scalar_rescaling",false)?,@"181 | -259/2+Group(195,1,1)+Group(196,2/7,1)+Group(198,1,1)+Group(199,7/2,1)+Group(206,1,1)+Group(207,-7/2,1)+Group(211,1,1)+Group(212,-2/7,1)+Group(74,1,1)+Group(75,7/2,1)+Group(80,1,1)+Group(81,-2/7,1) = -842/7");

    // 4>N no symmetrization
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d u u~ > e- d | e- a d u g ghg QED==2 [{0}] --numerator-grouping only_detect_zeroes",false)?,@"4 | 4 = 4");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d u u~ > e- d | e- a d u g ghg QED==2 [{1}] --numerator-grouping only_detect_zeroes",false)?,@"62 | 36 = 36");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d u u~ > e- d | e- a d u g ghg QED==2 [{2}] --numerator-grouping only_detect_zeroes",false)?,@"1428 | 1298/3 = 1298/3");

    // 4>N with symmetrization
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d u u~ > e- d | e- a d u g ghg QED==2 [{0}] --symmetrize-left-right-states true --symmetric-left-right-polarizations true --numerator-grouping group_identical_graphs_up_to_scalar_rescaling",false)?,@"4 | 4 = 4");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d u u~ > e- d | e- a d u g ghg QED==2 [{1}] --symmetrize-left-right-states true --symmetric-left-right-polarizations true --numerator-grouping group_identical_graphs_up_to_scalar_rescaling",false)?,@"54 | 48+Group(15,1,-1)+Group(16,1,-1)+Group(18,1,-1)+Group(19,1,-1)+Group(58,1,-1)+Group(59,1,-1)+Group(61,1,-1)+Group(62,1,-1) = 40");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "e- d u u~ > e- d | e- a d u g ghg QED==2 [{2}] --symmetrize-left-right-states true --symmetric-left-right-polarizations true --numerator-grouping group_identical_graphs_up_to_scalar_rescaling",false)?,@"1087 | 2552/3+Group(100,1,-1)+Group(101,-2/7,-1)+Group(1019,1,-1)+Group(102,1,-1)+Group(1020,1,-1)+Group(1021,1,-1)+Group(103,-2/7,-1)+Group(1065,-1/2,-1)+Group(1066,7/4,-1)+Group(1071,-1/2,-1)+Group(1073,7/4,-1)+Group(1081,1,-1)+Group(1082,1,-1)+Group(1083,1,-1)+Group(1111,-1/2,-1)+Group(1112,1/7,-1)+Group(1113,-1/2,-1)+Group(1114,1/7,-1)+Group(1126,1,-1)+Group(1127,1,-1)+Group(1128,1,-1)+Group(1129,1,-1)+Group(1136,1,-1)+Group(1137,1,-1)+Group(1138,1,-1)+Group(1139,1,-1)+Group(1140,1,-1)+Group(1141,1,-1)+Group(1142,1,-1)+Group(1156,1,-1)+Group(1157,7/2,-1)+Group(1206,1,-1)+Group(1207,1,-1)+Group(1208,1,-1)+Group(1210,1,-1)+Group(1212,1,-1)+Group(1214,1,-1)+Group(1216,1,-1)+Group(1217,1,-1)+Group(1218,1,1)+Group(1219,1,1)+Group(1220,1,1)+Group(1221,1,1)+Group(1222,1,-1)+Group(1223,1,-1)+Group(1224,1,-1)+Group(1225,1,-1)+Group(1226,1,-1)+Group(1227,1,-1)+Group(1297,1,-1)+Group(1326,-1/2,-1)+Group(1327,7/4,-1)+Group(1328,-1/2,-1)+Group(1330,7/4,-1)+Group(1348,1,-1)+Group(137,1,-1)+Group(138,1,-1)+Group(139,1,-1)+Group(1393,1,-1/2)+Group(1394,1,-1)+Group(1395,1,-1/2)+Group(1396,1,-1)+Group(1397,1,-1)+Group(1398,1,-1)+Group(1399,1,-1)+Group(140,1,-1)+Group(1400,1,-1)+Group(1401,1,-1)+Group(1402,1,-1)+Group(1403,1,-1)+Group(1404,1,-1)+Group(1405,1,-1)+Group(1406,1,-1)+Group(1407,1,-1)+Group(1408,1,-1)+Group(141,1,-1)+Group(1410,1,-1)+Group(1411,1,-1/2)+Group(1412,1,-1)+Group(1413,1,-1)+Group(1415,1,-1)+Group(1416,1,-1/2)+Group(1419,1,-1)+Group(142,1,-1)+Group(1420,1,-1)+Group(1421,1,-1)+Group(1422,1,-1/2)+Group(1423,1,-1)+Group(1424,1,-1/2)+Group(1425,1,-1)+Group(1426,1,-1)+Group(1427,1,-1)+Group(1428,1,-1)+Group(1429,1,-1)+Group(143,1,-1)+Group(1430,1,-1)+Group(1431,1,-1)+Group(1433,1,-1)+Group(1435,1,-1)+Group(1436,1,-1)+Group(1439,1,-1)+Group(144,1,-1)+Group(1440,1,-1)+Group(1441,1,-1)+Group(1442,1,-1)+Group(1443,1,-1)+Group(1444,1,-1/2)+Group(1445,1,-1)+Group(1446,1,-1)+Group(1447,1,-1)+Group(1448,1,-1/2)+Group(145,1,-1)+Group(146,1,-1)+Group(147,1,-1)+Group(1495,-1/2,-1)+Group(1510,1,-1)+Group(1511,1,-1)+Group(1513,7/2,-1)+Group(1514,1,-1)+Group(1515,1,-1)+Group(1517,7/2,-1)+Group(1518,1,-1)+Group(1519,2/7,-1)+Group(1520,1,-1)+Group(1521,7/2,-1)+Group(1522,1,-1)+Group(1525,1,-1)+Group(1528,1,-1)+Group(1529,7/2,-1)+Group(1530,1,-1)+Group(1531,1,-1)+Group(1532,7/2,-1)+Group(1533,1,-1)+Group(1536,1,-1)+Group(1537,2/7,-1)+Group(1538,1,-1)+Group(1539,7/2,-1)+Group(1542,1,-1)+Group(1543,1,-1)+Group(1562,1,-1)+Group(1563,1,-1)+Group(1564,1,-1)+Group(1565,1,-1)+Group(1566,1,-1)+Group(1567,1,-1)+Group(1568,1,-1)+Group(1569,1,-1)+Group(1607,-1/2,-1)+Group(1608,-1/2,-1)+Group(161,1,-1)+Group(162,7/2,-1)+Group(1648,1,-1)+Group(1649,1,-1)+Group(1650,1,-1)+Group(1651,1,-1)+Group(1661,1,-1)+Group(1662,1,-1)+Group(1663,1,-1)+Group(1664,1,-1)+Group(1665,1,-1)+Group(1666,1,-1)+Group(1667,1,-1)+Group(1668,1,-1)+Group(1669,1,1)+Group(1670,1,1)+Group(1671,1,1)+Group(1672,1,1)+Group(1673,1,-1)+Group(1674,1,-1)+Group(1675,1,-1)+Group(1676,1,-1)+Group(1677,1,-1)+Group(1678,1,-1)+Group(169,1,-1)+Group(170,1,-1)+Group(171,1,-1)+Group(172,1,-1)+Group(173,1,-1)+Group(174,1,-1)+Group(175,1,-1)+Group(178,1,-1)+Group(179,1,-1)+Group(180,1,-1)+Group(181,1,-1)+Group(184,1,-1)+Group(185,7/2,-1)+Group(243,1,-1)+Group(245,-7/2,-1)+Group(246,1,-1)+Group(247,-7/2,-1)+Group(265,1,-1)+Group(266,1,-1)+Group(321,1,-1/2)+Group(322,1,-1)+Group(323,1,-1/2)+Group(324,1,-1)+Group(325,1,-1)+Group(327,1,-1)+Group(329,1,-1)+Group(330,1,-1)+Group(331,1,-1)+Group(332,1,-1)+Group(333,1,-1)+Group(334,1,-1)+Group(335,1,-1)+Group(336,1,-1)+Group(339,1,-1)+Group(340,1,-1)+Group(341,1,-1)+Group(342,1,-1/2)+Group(343,1,-1)+Group(344,1,-1)+Group(345,1,-1)+Group(346,1,-1/2)+Group(347,1,-1)+Group(348,1,-1)+Group(349,1,-1)+Group(350,1,-1/2)+Group(351,1,-1)+Group(352,1,-1/2)+Group(353,1,-1)+Group(354,1,-1)+Group(355,1,-1)+Group(356,1,-1)+Group(357,1,-1)+Group(358,1,-1)+Group(359,1,-1)+Group(360,1,-1)+Group(361,1,-1)+Group(362,1,-1)+Group(363,1,-1)+Group(364,1,-1)+Group(365,1,-1)+Group(366,1,-1)+Group(368,1,-1)+Group(369,1,-1/2)+Group(370,1,-1)+Group(371,1,-1)+Group(373,1,-1)+Group(374,1,-1/2)+Group(379,1,-1)+Group(394,1,-1)+Group(395,1,-1)+Group(396,7/2,-1)+Group(397,1,-1)+Group(398,1,-1)+Group(399,7/2,-1)+Group(402,1,-1)+Group(403,2/7,-1)+Group(404,1,-1)+Group(405,7/2,-1)+Group(408,1,-1)+Group(409,1,-1)+Group(410,1,-1)+Group(412,7/2,-1)+Group(413,1,-1)+Group(414,1,-1)+Group(416,7/2,-1)+Group(417,1,-1)+Group(418,1,-1)+Group(419,2/7,-1)+Group(420,1,-1)+Group(421,7/2,-1)+Group(424,1,-1)+Group(427,1,-1)+Group(446,1,-1)+Group(447,1,-1)+Group(448,1,-1)+Group(449,1,-1)+Group(450,1,-1)+Group(451,1,-1)+Group(452,1,-1)+Group(453,1,-1)+Group(531,1,-1)+Group(532,1,-1)+Group(566,1,-1)+Group(567,1,-1)+Group(568,1,-1)+Group(569,1,-1)+Group(589,1,-1)+Group(59,1,-1)+Group(590,1,-1)+Group(591,1,1)+Group(592,1,1)+Group(593,1,1)+Group(594,1,1)+Group(595,1,-1)+Group(596,1,-1)+Group(597,1,-1)+Group(598,1,-1)+Group(599,1,-1)+Group(600,1,-1)+Group(601,1,-1)+Group(602,1,-1)+Group(603,1,-1)+Group(604,1,-1)+Group(605,1,-1)+Group(606,1,-1)+Group(61,-7/2,-1)+Group(62,1,-1)+Group(63,-7/2,-1)+Group(658,1,-1)+Group(659,1,-1)+Group(660,1,1)+Group(661,1,1)+Group(662,1,1)+Group(663,1,1)+Group(664,1,-1)+Group(665,1,-1)+Group(666,1,-1)+Group(667,1,-1)+Group(668,1,-1)+Group(669,1,-1)+Group(672,1,-1)+Group(673,1,-1)+Group(674,1,-1)+Group(676,1,-1)+Group(678,1,-1)+Group(680,1,-1)+Group(71,1,-1)+Group(72,1,-1)+Group(73,1,-1)+Group(80,1,-1)+Group(806,1,-1)+Group(807,1,-1)+Group(808,1,-1)+Group(809,1,-1)+Group(81,1,-1)+Group(810,1,-1)+Group(811,1,-1)+Group(812,1,-1)+Group(813,1,-1)+Group(82,1,-1)+Group(884,1,-1)+Group(885,1,-1)+Group(886,1,-1)+Group(887,1,-1)+Group(888,1,-1)+Group(889,1,-1)+Group(890,1,-1)+Group(891,1,-1)+Group(958,1,-1)+Group(959,1,-1)+Group(960,1,-1)+Group(961,1,-1)+Group(968,1,-1)+Group(969,1,-1)+Group(970,1,-1)+Group(971,1,-1)+Group(972,1,-1)+Group(973,1,-1)+Group(974,1,-1)+Group(977,1,-1)+Group(978,7/2,-1) = 22357/42");
...
fn test_slow_generate_a_qqh() -> Result<()> {
    let mut cli = get_test_cli(None, get_tests_workspace_path().join("feyn_gen_generation_test"), Some("feyngen".to_string()),true)?;
    cli.run_command(&format!("import model sm.json"))?;
    // cli.run_command(&format!("set global kv global.n_cores.feyngen=8"))?;

    assert_snapshot!(feyngen_str(&mut cli, "amp", "a > b b~ h | b h a ghg g QED==4 [{5} QCD=3] --symmetrize-left-right-states true --symmetric-left-right-polarizations true --numerator-grouping group_identical_graphs_up_to_scalar_rescaling",false)?,@"2763 | -38712/7");
...
fn test_generate_amplitude_1l_sm_jets() -> Result<()> {
    let mut cli = get_test_cli(None, get_tests_workspace_path().join("feyn_gen_generation_test"), Some("feyngen".to_string()),true)?;
    cli.run_command(&format!("import model sm.json"))?;
    //cli.run_command(&format!("set global kv global.n_cores.feyngen=16"))?;

    // Targets confirmed by MadGraph
    assert_snapshot!(feyngen_str(&mut cli, "amp", "d d~ > d d~ | u d g ghg a QED==0 [QCD=1] --numerator-grouping only_detect_zeroes",false)?,@"20 | 0 = 0");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "d d~ > d d~ g | u d g ghg a QED==0 [QCD=1] --numerator-grouping only_detect_zeroes",false)?,@"192 | 0 = 0");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "d d~ > g g g | u d g ghg a QED==0 [QCD=1] --numerator-grouping only_detect_zeroes",false)?,@"384 | -186 = -186");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "g g > g g g | u d g ghg a QED==0 [QCD=1] --numerator-grouping only_detect_zeroes",false)?,@"1139 | 171/2 = 171/2");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "d d~ > d d~ g g | u d g ghg a QED==0 [QCD=1] --numerator-grouping only_detect_zeroes",false)?,@"2284 | 0 = 0");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "d d~ > u u~ | u d g ghg a QED==0 [QCD=1] --numerator-grouping only_detect_zeroes",false)?,@"10 | -11/2 = -11/2");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "d d~ > u u~ g | u d g ghg a QED==0 [QCD=1] --numerator-grouping only_detect_zeroes",false)?,@"96 | -119/2 = -119/2");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "d d~ > u u~ g g | u d g ghg a QED==0 [QCD=1] --numerator-grouping only_detect_zeroes",false)?,@"1142 | -698 = -698");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "d d~ > u u~ d d~ | u d g ghg a QED==0 [QCD=1] --numerator-grouping only_detect_zeroes",false)?,@"414 | 0 = 0");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "d d~ > d d~ d d~ | u d g ghg a QED==0 [QCD=1] --numerator-grouping only_detect_zeroes",false)?,@"1242 | 0 = 0");
...
fn test_generate_amplitude_1l_sm_jets_with_grouping() -> Result<()> {
    ...
    // Targets confirmed by MadGraph
    assert_snapshot!(feyngen_str(&mut cli, "amp", "d d~ > d d~ | u d g ghg a QED==0 [QCD=1] --numerator-grouping group_identical_graphs_up_to_sign",false)?,@"18 | Group(0,1,-1)+Group(1,1,1)+Group(4,1,-1)+Group(5,1,1) = 0");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "d d~ > u u~ | u d g ghg a QED==0 [QCD=1] --numerator-grouping group_identical_graphs_up_to_sign",false)?,@"9 | -15/2+Group(0,1,1)+Group(7,1,1) = -11/2");

    assert_snapshot!(feyngen_str(&mut cli, "amp", "d d~ > u u~ g | u d g ghg a QED==0 [QCD=1] --numerator-grouping group_identical_graphs_up_to_sign",false)?,@"88 | -151/2+Group(0,1,1)+Group(1,1,1)+Group(14,1,1)+Group(15,1,1)+Group(34,1,1)+Group(35,1,1)+Group(44,1,1)+Group(45,1,1)+Group(56,1,1)+Group(57,1,1)+Group(68,1,1)+Group(69,1,1)+Group(76,1,1)+Group(85,1,1)+Group(86,1,1)+Group(95,1,1) = -119/2");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "d d~ > d d~ g | u d g ghg a QED==0 [QCD=1] --numerator-grouping group_identical_graphs_up_to_sign",false)?,@"176 | Group(0,1,1)+Group(1,1,-1)+Group(105,1,1)+Group(106,1,-1)+Group(119,1,1)+Group(120,1,-1)+Group(130,1,1)+Group(131,1,-1)+Group(144,1,1)+Group(145,1,-1)+Group(152,1,-1)+Group(153,1,1)+Group(166,1,-1)+Group(167,1,1)+Group(172,1,-1)+Group(173,1,1)+Group(186,1,-1)+Group(187,1,1)+Group(2,1,-1)+Group(24,1,1)+Group(25,1,-1)+Group(26,1,-1)+Group(27,1,1)+Group(3,1,1)+Group(4,1,-1)+Group(5,1,-1)+Group(6,1,1)+Group(68,1,-1)+Group(69,1,-1)+Group(7,1,1)+Group(70,1,1)+Group(71,1,1) = 0");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "d d~ > g g g | u d g ghg a QED==0 [QCD=1] --numerator-grouping group_identical_graphs_up_to_sign",false)?,@"341 | -272+Group(0,1,1)+Group(1,1,1)+Group(10,1,1)+Group(11,1,1)+Group(12,1,1)+Group(13,1,1)+Group(130,1,1)+Group(131,1,1)+Group(14,1,1)+Group(140,1,1)+Group(141,1,1)+Group(15,1,1)+Group(150,1,1)+Group(151,1,1)+Group(154,1,1)+Group(155,1,1)+Group(158,1,1)+Group(159,1,1)+Group(16,1,1)+Group(167,1,1)+Group(168,1,1)+Group(17,1,1)+Group(171,1,1)+Group(172,1,1)+Group(175,1,1)+Group(176,1,1)+Group(179,1,1)+Group(18,1,1)+Group(180,1,1)+Group(19,1,1)+Group(2,1,1)+Group(20,1,1)+Group(21,1,1)+Group(22,1,1)+Group(226,1,1)+Group(227,1,1)+Group(228,1,1)+Group(23,1,1)+Group(24,1,1)+Group(242,1,1)+Group(249,1,1)+Group(250,1,1)+Group(253,1,1)+Group(254,1,1)+Group(255,1,1)+Group(269,1,1)+Group(276,1,1)+Group(277,1,1)+Group(280,1,1)+Group(281,1,1)+Group(282,1,1)+Group(292,1,1)+Group(299,1,1)+Group(3,1,1)+Group(300,1,1)+Group(303,1,1)+Group(304,1,1)+Group(305,1,1)+Group(315,1,1)+Group(322,1,1)+Group(323,1,1)+Group(330,1,1)+Group(331,1,1)+Group(332,1,1)+Group(342,1,1)+Group(349,1,1)+Group(350,1,1)+Group(357,1,1)+Group(358,1,1)+Group(359,1,1)+Group(369,1,1)+Group(376,1,1)+Group(377,1,1)+Group(4,1,1)+Group(5,1,1)+Group(6,1,1)+Group(7,1,1)+Group(8,1,1)+Group(84,1,1)+Group(85,1,1)+Group(86,1,1)+Group(87,1,1)+Group(88,1,1)+Group(89,1,1)+Group(9,1,1)+Group(90,1,1) = -186");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "g g > g g g | g ghg a QED==0 [QCD=1] --numerator-grouping group_identical_graphs_up_to_sign",false)?,@"671 | 1107/2 = 1107/2");
    // For fun, symmetrize it all
    assert_snapshot!(feyngen_str(&mut cli, "amp", "g g > g g g | g ghg a QED==0 [QCD=1] --symmetrize-initial-states true --symmetrize-final-states true --numerator-grouping group_identical_graphs_up_to_sign",false)?,@"109 | 1107/2 = 1107/2");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "g g > g g g | g ghg a QED==0 [QCD=1] --symmetrize-left-right-states true --symmetrize-initial-states true --symmetrize-final-states true --numerator-grouping group_identical_graphs_up_to_sign",false)?,@"25 | 1107/2 = 1107/2");
    assert_snapshot!(feyngen_str(&mut cli, "amp", "g g > g g g | u d g ghg a QED==0 [QCD=1] --numerator-grouping group_identical_graphs_up_to_sign",false)?,@"905 | 1107/2+Group(0,1,-1)+Group(1,1,-1)+Group(10,1,-1)+Group(100,1,-1)+Group(1000,1,-1)+Group(1001,1,-1)+Group(1002,1,-1)+Group(1003,1,-1)+Group(1004,1,-1)+Group(1005,1,-1)+Group(1006,1,-1)+Group(1007,1,-1)+Group(1008,1,-1)+Group(1009,1,-1)+Group(101,1,-1)+Group(1010,1,-1)+Group(1011,1,-1)+Group(1012,1,-1)+Group(1013,1,-1)+Group(1014,1,-1)+Group(1015,1,-1)+Group(1016,1,-1)+Group(1017,1,-1)+Group(1018,1,-1)+Group(1019,1,-1)+Group(102,1,-1)+Group(1020,1,-1)+Group(1021,1,-1)+Group(1022,1,-1)+Group(1023,1,-1)+Group(1024,1,-1)+Group(1025,1,-1)+Group(1026,1,-1)+Group(1027,1,-1)+Group(1028,1,-1)+Group(1029,1,-1)+Group(103,1,-1)+Group(1030,1,-1)+Group(1031,1,-1)+Group(1032,1,-1)+Group(1033,1,-1)+Group(1034,1,-1)+Group(1035,1,-1)+Group(1036,1,-1)+Group(1037,1,-1)+Group(1038,1,-1)+Group(1039,1,-1)+Group(104,1,-1)+Group(1040,1,-1)+Group(1041,1,-1)+Group(1042,1,-1)+Group(1043,1,-1)+Group(1044,1,-1)+Group(1045,1,-1)+Group(1046,1,-1)+Group(1047,1,-1)+Group(1048,1,-1)+Group(1049,1,-1)+Group(105,1,-1)+Group(1050,1,-1)+Group(1051,1,-1)+Group(1052,1,-1)+Group(1053,1,-1)+Group(1054,1,-1)+Group(1055,1,-1)+Group(1056,1,-1)+Group(1057,1,-1)+Group(1058,1,-1)+Group(1059,1,-1)+Group(106,1,-1)+Group(1060,1,-1)+Group(1061,1,-1)+Group(1062,1,-1)+Group(1063,1,-1)+Group(1064,1,-1)+Group(1065,1,-1)+Group(1066,1,-1)+Group(1067,1,-1)+Group(1068,1,-1)+Group(1069,1,-1)+Group(107,1,-1)+Group(1070,1,-1)+Group(1071,1,-1)+Group(1072,1,-1)+Group(1073,1,-1)+Group(1074,1,-1)+Group(1075,1,-1)+Group(1076,1,-1)+Group(1077,1,-1)+Group(1078,1,-1)+Group(1079,1,-1)+Group(108,1,-1)+Group(1080,1,-1)+Group(1081,1,-1)+Group(1082,1,-1)+Group(1083,1,-1)+Group(1084,1,-1)+Group(1085,1,-1)+Group(1086,1,-1)+Group(1087,1,-1)+Group(1088,1,-1)+Group(1089,1,-1)+Group(109,1,-1)+Group(1090,1,-1)+Group(1091,1,-1)+Group(1092,1,-1)+Group(1093,1,-1)+Group(1094,1,-1)+Group(1095,1,-1)+Group(1096,1,-1)+Group(1097,1,-1)+Group(1098,1,-1)+Group(1099,1,-1)+Group(11,1,-1)+Group(110,1,-1)+Group(1100,1,-1)+Group(1101,1,-1)+Group(1102,1,-1)+Group(1103,1,-1)+Group(1104,1,-1)+Group(1105,1,-1)+Group(1106,1,-1)+Group(1107,1,-1)+Group(1108,1,-1)+Group(1109,1,-1)+Group(111,1,-1)+Group(1110,1,-1)+Group(1111,1,-1)+Group(1112,1,-1)+Group(1113,1,-1)+Group(1114,1,-1)+Group(1115,1,-1)+Group(1116,1,-1)+Group(1117,1,-1)+Group(1118,1,-1)+Group(1119,1,-1)+Group(112,1,-1)+Group(1120,1,-1)+Group(1121,1,-1)+Group(1122,1,-1)+Group(1123,1,-1)+Group(1124,1,-1)+Group(1125,1,-1)+Group(1126,1,-1)+Group(1127,1,-1)+Group(1128,1,-1)+Group(1129,1,-1)+Group(113,1,-1)+Group(1130,1,-1)+Group(1131,1,-1)+Group(1132,1,-1)+Group(1133,1,-1)+Group(1134,1,-1)+Group(1135,1,-1)+Group(1136,1,-1)+Group(1137,1,-1)+Group(1138,1,-1)+Group(114,1,-1)+Group(115,1,-1)+Group(116,1,-1)+Group(117,1,-1)+Group(118,1,-1)+Group(119,1,-1)+Group(12,1,-1)+Group(120,1,-1)+Group(121,1,-1)+Group(122,1,-1)+Group(123,1,-1)+Group(124,1,-1)+Group(125,1,-1)+Group(126,1,-1)+Group(127,1,-1)+Group(128,1,-1)+Group(129,1,-1)+Group(13,1,-1)+Group(130,1,-1)+Group(131,1,-1)+Group(132,1,-1)+Group(133,1,-1)+Group(134,1,-1)+Group(135,1,-1)+Group(136,1,-1)+Group(137,1,-1)+Group(138,1,-1)+Group(139,1,-1)+Group(14,1,-1)+Group(140,1,-1)+Group(141,1,-1)+Group(142,1,-1)+Group(143,1,-1)+Group(144,1,-1)+Group(145,1,-1)+Group(146,1,-1)+Group(147,1,-1)+Group(148,1,-1)+Group(149,1,-1)+Group(15,1,-1)+Group(150,1,-1)+Group(151,1,-1)+Group(152,1,-1)+Group(153,1,-1)+Group(154,1,-1)+Group(155,1,-1)+Group(156,1,-1)+Group(157,1,-1)+Group(158,1,-1)+Group(159,1,-1)+Group(16,1,-1)+Group(160,1,-1)+Group(161,1,-1)+Group(162,1,-1)+Group(163,1,-1)+Group(164,1,-1)+Group(165,1,-1)+Group(166,1,-1)+Group(167,1,-1)+Group(168,1,-1)+Group(169,1,-1)+Group(17,1,-1)+Group(170,1,-1)+Group(171,1,-1)+Group(172,1,-1)+Group(173,1,-1)+Group(174,1,-1)+Group(175,1,-1)+Group(176,1,-1)+Group(177,1,-1)+Group(178,1,-1)+Group(179,1,-1)+Group(18,1,-1)+Group(180,1,-1)+Group(181,1,-1)+Group(182,1,-1)+Group(183,1,-1)+Group(184,1,-1)+Group(185,1,-1)+Group(186,1,-1)+Group(187,1,-1)+Group(188,1,-1)+Group(189,1,-1)+Group(19,1,-1)+Group(190,1,-1)+Group(191,1,-1)+Group(192,1,-1)+Group(193,1,-1)+Group(194,1,-1)+Group(195,1,-1)+Group(196,1,-1)+Group(197,1,-1)+Group(198,1,-1)+Group(199,1,-1)+Group(2,1,-1)+Group(20,1,-1)+Group(200,1,-1)+Group(201,1,-1)+Group(202,1,-1)+Group(203,1,-1)+Group(204,1,-1)+Group(205,1,-1)+Group(206,1,-1)+Group(207,1,-1)+Group(208,1,-1)+Group(209,1,-1)+Group(21,1,-1)+Group(210,1,-1)+Group(211,1,-1)+Group(212,1,-1)+Group(213,1,-1)+Group(214,1,-1)+Group(215,1,-1)+Group(216,1,-1)+Group(217,1,-1)+Group(218,1,-1)+Group(219,1,-1)+Group(22,1,-1)+Group(220,1,-1)+Group(221,1,-1)+Group(222,1,-1)+Group(223,1,-1)+Group(224,1,-1)+Group(225,1,-1)+Group(226,1,-1)+Group(227,1,-1)+Group(228,1,-1)+Group(229,1,-1)+Group(23,1,-1)+Group(230,1,-1)+Group(231,1,-1)+Group(232,1,-1)+Group(233,1,-1)+Group(24,1,-1)+Group(25,1,-1)+Group(26,1,-1)+Group(27,1,-1)+Group(28,1,-1)+Group(29,1,-1)+Group(3,1,-1)+Group(30,1,-1)+Group(31,1,-1)+Group(32,1,-1)+Group(33,1,-1)+Group(34,1,-1)+Group(35,1,-1)+Group(36,1,-1)+Group(37,1,-1)+Group(38,1,-1)+Group(39,1,-1)+Group(4,1,-1)+Group(40,1,-1)+Group(41,1,-1)+Group(42,1,-1)+Group(43,1,-1)+Group(44,1,-1)+Group(45,1,-1)+Group(46,1,-1)+Group(47,1,-1)+Group(48,1,-1)+Group(49,1,-1)+Group(5,1,-1)+Group(50,1,-1)+Group(51,1,-1)+Group(52,1,-1)+Group(53,1,-1)+Group(54,1,-1)+Group(55,1,-1)+Group(56,1,-1)+Group(57,1,-1)+Group(58,1,-1)+Group(59,1,-1)+Group(6,1,-1)+Group(60,1,-1)+Group(61,1,-1)+Group(62,1,-1)+Group(63,1,-1)+Group(64,1,-1)+Group(65,1,-1)+Group(66,1,-1)+Group(67,1,-1)+Group(68,1,-1)+Group(69,1,-1)+Group(7,1,-1)+Group(70,1,-1)+Group(71,1,-1)+Group(72,1,-1)+Group(73,1,-1)+Group(74,1,-1)+Group(75,1,-1)+Group(76,1,-1)+Group(77,1,-1)+Group(78,1,-1)+Group(79,1,-1)+Group(8,1,-1)+Group(80,1,-1)+Group(81,1,-1)+Group(82,1,-1)+Group(83,1,-1)+Group(84,1,-1)+Group(85,1,-1)+Group(86,1,-1)+Group(87,1,-1)+Group(88,1,-1)+Group(89,1,-1)+Group(9,1,-1)+Group(90,1,-1)+Group(905,1,-1)+Group(906,1,-1)+Group(907,1,-1)+Group(908,1,-1)+Group(909,1,-1)+Group(91,1,-1)+Group(910,1,-1)+Group(911,1,-1)+Group(912,1,-1)+Group(913,1,-1)+Group(914,1,-1)+Group(915,1,-1)+Group(916,1,-1)+Group(917,1,-1)+Group(918,1,-1)+Group(919,1,-1)+Group(92,1,-1)+Group(920,1,-1)+Group(921,1,-1)+Group(922,1,-1)+Group(923,1,-1)+Group(924,1,-1)+Group(925,1,-1)+Group(926,1,-1)+Group(927,1,-1)+Group(928,1,-1)+Group(929,1,-1)+Group(93,1,-1)+Group(930,1,-1)+Group(931,1,-1)+Group(932,1,-1)+Group(933,1,-1)+Group(934,1,-1)+Group(935,1,-1)+Group(936,1,-1)+Group(937,1,-1)+Group(938,1,-1)+Group(939,1,-1)+Group(94,1,-1)+Group(940,1,-1)+Group(941,1,-1)+Group(942,1,-1)+Group(943,1,-1)+Group(944,1,-1)+Group(945,1,-1)+Group(946,1,-1)+Group(947,1,-1)+Group(948,1,-1)+Group(949,1,-1)+Group(95,1,-1)+Group(950,1,-1)+Group(951,1,-1)+Group(952,1,-1)+Group(953,1,-1)+Group(954,1,-1)+Group(955,1,-1)+Group(956,1,-1)+Group(957,1,-1)+Group(958,1,-1)+Group(959,1,-1)+Group(96,1,-1)+Group(960,1,-1)+Group(961,1,-1)+Group(962,1,-1)+Group(963,1,-1)+Group(964,1,-1)+Group(965,1,-1)+Group(966,1,-1)+Group(967,1,-1)+Group(968,1,-1)+Group(969,1,-1)+Group(97,1,-1)+Group(970,1,-1)+Group(971,1,-1)+Group(972,1,-1)+Group(973,1,-1)+Group(974,1,-1)+Group(975,1,-1)+Group(976,1,-1)+Group(977,1,-1)+Group(978,1,-1)+Group(979,1,-1)+Group(98,1,-1)+Group(980,1,-1)+Group(981,1,-1)+Group(982,1,-1)+Group(983,1,-1)+Group(984,1,-1)+Group(985,1,-1)+Group(986,1,-1)+Group(987,1,-1)+Group(988,1,-1)+Group(989,1,-1)+Group(99,1,-1)+Group(990,1,-1)+Group(991,1,-1)+Group(992,1,-1)+Group(993,1,-1)+Group(994,1,-1)+Group(995,1,-1)+Group(996,1,-1)+Group(997,1,-1)+Group(998,1,-1)+Group(999,1,-1) = 171/2");
...
fn test_vaccuum_amplitude_generation_full_sm() -> Result<()> {
    ...
    // Including all graphs
    assert_snapshot!(feyngen_str(&mut cli, "amp", "{} > {} [{2}] --numerator-grouping only_detect_zeroes --max-n-bridges -1 --number-of-factorized-loop-subtopologies -1 -1 --filter-zero-flow-edges false --filter-selfenergies false --filter-tadpoles false --filter-snails false",false)?,@"448 | TBD");
    ...
    // assert_snapshot!(generate_graphs_and_count_to_str(&mut cli, "amp", "{} > {} [{2}] --numerator-grouping group_identical_graphs_up_to_scalar_rescaling --max-n-bridges -1 --number-of-factorized-loop-subtopologies -1 -1 --compare-canonized-numerator false --number-of-samples-for-numerator-comparisons 3 --no-fully-numerical-substitution-when-comparing-numerators",false)?,@"? | ?");
    ...
    assert_snapshot!(feyngen_str(&mut cli, "amp", "{} > {} [{2}] --numerator-grouping group_identical_graphs_up_to_scalar_rescaling --max-n-bridges -1 --number-of-factorized-loop-subtopologies -1 -1",false)?,@"243 | -27/2*UFO::G^2*UFO::ee^-2-UFO::CKM1x1^-1*UFO::CKM1x2*UFO::complexconjugate(UFO::CKM1x1)^-1*UFO::complexconjugate(UFO::CKM1x2)-UFO::CKM2x1^-1*UFO::CKM2x2*UFO::complexconjugate(UFO::CKM2x1)^-1*UFO::complexconjugate(UFO::CKM2x2)-UFO::CKM3x1^-1*UFO::CKM3x2*UFO::complexconjugate(UFO::CKM3x1)^-1*UFO::complexconjugate(UFO::CKM3x2)-UFO::I2x12^-1*UFO::I2x22*UFO::I3x21^-1*UFO::I3x22-UFO::I2x13^-1*UFO::I2x23*UFO::I3x31^-1*UFO::I3x32+313/24");
